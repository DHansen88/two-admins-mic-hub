...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
  <tr><td style="background-color:#1a1a2e;padding:30px 40px;text-align:center;">
    <h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:700;">Two Admins and a Mic&trade;</h1>
  ...
  <tr><td style="padding:40px;">
    ...
    <p style="color:#555555;font-size:15px;line-height:1.6;margin:0 0 20px;">We received a request to reset the password for your <strong>Two Admins and a Mic&trade;</strong> Admin Dashboard account.</p>
  ...
  <tr><td style="background-color:#f8f8fa;padding:25px 40px;text-align:center;">
    <p style="margin:0;color:#999999;font-size:12px;">Thank you,<br><strong>Two Admins and a Mic&trade;</strong><br>Content Management Team</p>
  </td></tr>
</table>
</td></tr>
</table>
