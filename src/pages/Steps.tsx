      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-muted-foreground text-2xl md:text-4xl">The <span className="font-bold text-coral inline-block animate-[spin-drop_1s_ease-out_0.3s_both]">6</span> Core Steps</p>
