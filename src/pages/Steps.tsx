    ...
    <>
      ...
      <div className="text-center mt-12">
        <Button asChild size="lg" className="bg-teal hover:bg-teal/90 text-background font-semibold px-8 py-6 text-base">
          <a
            href="https://conantleadership.mykajabi.com/offers/JCoEFqw7/checkout"
            target="_blank"
            rel="noopener noreferrer"
            data-track="steps-checkout"
            data-track-label="Start Your STEPS Leadership Program"
          >
            Start Your STEPS Leadership Program
          </a>
        </Button>
      </div>
    </>);
      ...
      <div
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-muted-foreground text-2xl md:text-4xl">The <span className={`font-bold text-coral inline-block ${isVisible ? "animate-spin-drop" : "opacity-0"}`}>6</span> Core Steps</p>
          ...
          return <div key={benefit.title} className="flex-[0_0_100%] sm:flex-[0_0_45%] lg:flex-[0_0_33.333%] min-w-0 pl-4">
                <div className="text-center space-y-3 p-6 rounded-xl bg-background/5 backdrop-blur-sm border border-background/10 hover:bg-background/10 transition-all duration-300 group cursor-default h-full flex flex-col items-center justify-start">
                  <div className="w-14 h-14 rounded-full flex items-center justify-center mx-auto transition-colors flex-shrink-0 bg-destructive">
                    <Icon className="w-6 h-6 animate-[pulse_3s_ease-in-out_infinite] group-hover:animate-[bounce_0.4s_ease-in-out_1] text-red-50" />
                  </div>
            ...
            <div className="max-w-3xl mx-auto text-center space-y-8">
              ...
              <Button asChild size="lg" className="bg-coral hover:bg-coral/90 text-background font-semibold px-10 py-6 text-base">
                <a
                  ...
                  rel="noopener noreferrer"
                  data-track="steps-checkout"
                  data-track-label="Start Your Leadership Journey"
                >
