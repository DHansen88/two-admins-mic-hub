                ...
                return (
                  <rect
                    ...
                    style={{
                      ...
                      animation: `eq-pulse-blog ${duration}s ease-in-out ${delay}s infinite`,
                    }}
                  />
                );
              })}
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-5 animate-fade-in">
              ...
              <p className="text-lg md:text-xl text-background/80">
                Insights, stories, and strategies for the admins who run the world.
              </p>
            </div>
          </div>
        </section>
